...
| **Management** | check-docs, init-docs, manage-adrs, manage-claude-md, manage-docs, manage-rules | Profile and content management (unified manage-* naming) |
| **Sync** | update-framework, update-guides, update-permissions, update-pillars, update-skills | Framework synchronization between projects |
