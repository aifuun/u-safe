...
2. 从每个 `SKILL.md` 的 YAML frontmatter 提取 `name` 和 `description`
3. 按功能分类（Issue Lifecycle, Quality, Management, Sync 等）
4. 生成简洁列表，每个 skill 一行：`/skill-name - 简短描述`

**示例格式**：
- **/start-issue** - Begin work on GitHub issue
- **/review** - Validate code quality
...
- **/finish-issue** - Complete issue and merge

### Quality & Validation (3 skills)
- **/review** - Validate code quality
- **/eval-plan** - Evaluate implementation plan
