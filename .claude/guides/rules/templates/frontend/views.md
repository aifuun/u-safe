...
category: "frontend"
title: "Views"
description: "View layer organization"
...
| Need | File | When |
|------|------|------|
| View examples | `.claude/pillars/pillar-l/headless.ts` | New view component |
| Full checklist | `.claude/pillars/pillar-l/checklist.md` | Code review |
| Detailed docs | `.claude/pillars/pillar-l/headless.md` | Uncertain implementation |
