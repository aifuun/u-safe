...
## Related
- **Pillar I**: `.prot/pillars/q3-structure-boundaries/pillar-i/firewalls.md` (import prevention)
- **Pillar J**: `.prot/pillars/q3-structure-boundaries/pillar-j/locality.md` (state management)
