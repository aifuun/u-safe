...
> 📖 **Complete Guide**: `.prot/pillars/q4-resilience-observability/pillar-m/saga.md`
...
## Related
- **Pillar M**: `.prot/pillars/q4-resilience-observability/pillar-m/saga.md` (complete Saga guide)
