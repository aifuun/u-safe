...
- Related: `.claude/pillars/CHEATSHEET.md` - tier classification reference
- Related: Pillar Q, F, M, R - T3 requirements
- Templates:
  - T1: `.claude/pillars/pillar-e/tier1-fetcher.ts`
  - T2: `.claude/pillars/pillar-e/tier2-headless.ts`
  - T3: `.claude/pillars/pillar-e/tier3-saga.ts`
- Checklist: `.claude/pillars/pillar-e/checklist.md`
